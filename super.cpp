...
Super::Super(int loop, int notification, int period, bool save, QObject *parent)
    : QObject(parent)
{
    p1 = new Program(loop,notification,period,save,0,"qt_norm_",0);
    p2 = new Program(loop,notification,period,save,1,"pos_norm_",0);
    p3 = new Program(loop,notification,period,save,0,"qt_hi_",0);
    p4 = new Program(loop,notification,period,save,1,"pos_hi_",0);
